...
//    }
    ...
    @Test
    @Transactional
    public void shouldDeleteVisitsOnDeletingPets(){
        assertThat(this.clinicService.findAllVisits().size()).isEqualTo(4);

        Pet pet = this.clinicService.findPetById(8);

        this.clinicService.deletePet(pet);

        pet = this.clinicService.findPetById(8);

        assertThat(pet).isNull();

        assertThat(this.clinicService.findAllVisits().size()).isEqualTo(2);
    }

    @Test
    @Transactional
    public void shouldDeleteVisitsOnDeletingVets(){
        assertThat(this.clinicService.findAllVisits().size()).isEqualTo(4);
        ...
        vet = this.clinicService.findVetById(2);

        assertThat(vet).isNull();

        assertThat(this.clinicService.findAllVisits().size()).isEqualTo(3);
    }

    @Test
    @Transactional
    public void shouldFindPetsThatVisitedVetByVetId(){
        Collection<Pet> pets = this.clinicService.findVisitedPetsByVetId(3);
