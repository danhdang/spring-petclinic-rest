...
public class VetRestController {
	...
	@RequestMapping(value = "/{vetId}/visitedpets", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public ResponseEntity<Collection<Pet>> getVisitedPets(@PathVariable("vetId") int vetId){
		Collection<Pet> pets = this.clinicService.findVisitedPetsByVetId(vetId);
		if (pets.isEmpty()){
